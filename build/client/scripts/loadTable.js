...
var API_1 = __importDefault(require("../class/API"));
//  LISTENERS
...
function updateCart(cart) {
    return __awaiter(this, void 0, void 0, function () {
        var ProductsIDs, IDList, response, products;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ProductsIDs = cart.getProductsIDs();
                    IDList = Object.keys(ProductsIDs);
                    return [4 /*yield*/, API_1.default.fetchAPI(Router_1.default.createURL("/products/ids"), {
                            IDList: IDList,
                        })];
                case 1:
                    response = _a.sent();
...
function loadTable(cart) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var products, _a, total, CartTable;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, updateCart(cart)];
                case 1:
                    _b.sent();
                    cart.isCartError();
                    products = cart.getProducts();
                    _a = (0, CartTableComponent_1.default)(products), total = _a.total, CartTable = _a.CartTable;
                    setCartElements(CartTable, total);
                    (0, lastMomentShopListener_1.default)(loadTable, cart);
                    (0, updateQuantityProducts_1.default)(cart.getQuantityProducts());
                    return [2 /*return*/];
            }
        });
    });
