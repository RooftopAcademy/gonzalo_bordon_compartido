    ...
    Array.from(SHOP_BUTTONS).forEach(function (button) {
        button.addEventListener(SHOP_BUTTONS_EVENT, function (e) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = e.target.dataset.cod;
                        return [4 /*yield*/, API_1.default.getPost(id)];
                    case 1:
                        product = _a.sent();
                        if (!API_1.default.isApiError(product)) {
                            main_1.default.cart.addToCart(product);
                            (0, updateQuantityProducts_1.default)(String(main_1.default.cart.getQuantityProducts()));
                        }
                        return [2 /*return*/];
                }
            });
