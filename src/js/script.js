...
exports.listenToMenuHandlerButtons = exports.updateQuantityProducts = exports.listenToShopButtons = exports.getSearch = void 0;
...
//  URL
var URL_SEARCH = new URLSearchParams(document.location.search.replace("?", ""));
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (typeof product !== "string") {
                            ...
                            updateQuantityProducts(String(config_1.CART.getQuantityProducts()));
                        }
                        else {
